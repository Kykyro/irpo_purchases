...
console.log(data);
            for(let i = 0; i < data.length; i++)
            {
                ...
                regionList.append(`<tr class="region-list-elem" data-id="${i}"><td> ${data[i].name}</td></tr>`)
            }
            ...
            let regionListElem = $('.region-list-elem');
            regionListElem.on('mouseenter', function () {
                console.log(map.regions[$(this).data('id')].region);
