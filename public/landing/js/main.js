! function(e) {
    ...
    function l() {
        return e().slick ? (e(".ed-slider").length > 0 && e(".ed-slider").each((function() {
        ...
        }))), void(e(".ed-carousel3").length > 0 && e(".ed-carousel3").each((function() {
            var a = e(this),
                t = a.data("arrows") || !0,
                i = a.data("dots") || !0,
                o = a.data("loop") || !0;
        ...
        }))), void(e(".ed-carousel6").length > 0 && e(".ed-carousel6").each((function() {
            var a = e(this),
                t = a.data("arrows") || !0,
                i = a.data("dots") || !0,
                o = a.data("loop") || !0;
        ...
        }))), void(e(".ed-carousel7").length > 0 && e(".ed-carousel7").each((function() {
            var a = e(this),
                t = a.data("arrows") || !0,
                i = a.data("dots") || !0,
                o = a.data("loop") || !0;
            a.slick({
                ...
                autoplaySpeed: 10000,
                speed: 1200,
                prevArrow: '<button id="prev" type="button" class="slick-prev2"><i class="fa fa-chevron-up" aria-hidden="true"></i></button>',
                nextArrow: '<button id="next" type="button" class="slick-next2"><i class="fa fa-chevron-down" aria-hidden="true"></i></button>',
                dotsClass: 'slick-dots2',
                waitForAnimate: false,
                slide: ".carousel-item7",
                slidesToShow: 2,
                slidesToScroll: 1,
                pauseOnHover: false,
                cssEase: 'linear',
        ...
        }))), void(e(".ed-carousel8").length > 0 && e(".ed-carousel8").each((function() {
            var a = e(this),
                t = a.data("arrows") || !0,
                i = a.data("dots") || !0,
                o = a.data("loop") || !0;
