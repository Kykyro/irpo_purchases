 ...
 */
final class Version20230301083253 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favorites_clusters ADD CONSTRAINT FK_5D386E939133FDD FOREIGN KEY (cluster_id_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
