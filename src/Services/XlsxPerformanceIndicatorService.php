...
class XlsxPerformanceIndicatorService extends AbstractController
{
    ...
    public function tableGenerator($users, $year, $dict)
    {
        ...
        $rangeTotal = 'A6:AC'.($sheet->getHighestRow());
