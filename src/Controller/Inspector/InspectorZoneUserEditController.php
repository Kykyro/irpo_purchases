...
use App\Form\inspectorZoneEditFormType;
 ...
 * @Route("/inspector")
 */
class InspectorZoneUserEditController extends AbstractController
{
    /**
     * @Route("/user_zone_edit/{id}", name="app_inspector_user_zone_edit", methods="GET|POST")
     */
    public function index(Request $request, int $id): Response
    {
        ...
        $form = $this->createForm(inspectorZoneEditFormType::class, $user_info);
        ...
        return $this->render('inspector/templates/userZoneEdit.html.twig', [
