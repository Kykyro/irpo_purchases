 ...
 * @Route("/bas-curator")
 */
class BasCuratorPurchasesController extends AbstractController
{
    /**
     * @Route("/purchases", name="app_bas_curator_purchases", methods="GET|POST")
     */
    ...
    /**
     * @Route("/find-clusters/{year}/{region}", name="app_bas_curator_finded_cluster", methods="GET|POST")
     */
    ...
    /**
     * @Route("/show-purchases/{id}", name="app_bas_curator_show_purchases", methods="GET|POST")
     */
    public function showPurchases(Request $request, int $id, budgetSumService $budgetSumService, XlsxService $xlsxService, SerializerInterface $serializer): Response
    {
        ...
        if($form2->isSubmitted() and $form2->isValid())
        {
            ...
            return $this->render('bas_curator/showPurchases.html.twig', [
                'controller_name' => 'InspectorController',
                'prodProc' => $prodProc,
                'id' => $id,
    ...
    /**
     * @Route("/view-purchases/{id}", name="app_bas_curator_view_purchase", methods="GET|POST")
     */
    ...
    /**
     * @Route("/get/purchasses-xlsx/{user_id}", name="download_purchases_xlsx_bas")
     */
