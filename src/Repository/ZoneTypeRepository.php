...
/**
 * @extends ServiceEntityRepository<ZoneType>
 *
...
class ZoneTypeRepository extends ServiceEntityRepository
{
    ...
    public function add(ZoneType $entity, bool $flush = false): void
    {
    ...
    public function remove(ZoneType $entity, bool $flush = false): void
    {
