...
use App\Repository\InitialContractPriceRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=InitialContractPriceRepository::class)
 */
class InitialContractPrice
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    public function getFederalFunds(): ?float
    {
